...
const cards = [
  {
    ...
    longDescription:
      "Our payment gateway uses advanced fraud detection, tokenization, and end-to-end encryption. Trusted by enterprises and startups alike, Kuber Payss ensures zero compromise with customer data.",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "Kuber Payss enables omnichannel payments for your business. Manage all transactions in real-time across all customer touchpoints.",
    features: [
